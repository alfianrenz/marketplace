                    ...
                    <div class="fxt-content">
                        <div class="fxt-header">
                            ...
                            <div class="fxt-page-switcher">
                                <a href="<?= site_url('auth/login_member'); ?>" class="switcher-text1 active">Masuk</a>
                                <a href="<?= site_url('auth/registrasi_member'); ?>" class="switcher-text1">Daftar</a>
                            </div>
                        </div>

                        <div class="fxt-form">
                            <h2 class="mb-2">Login</h2>
                            <p>Login dan mulai berbelanja</p>

                            <?= $this->session->userdata('message'); ?>
                            <form method="POST" action="<?= site_url('auth/login_member'); ?>">
                                ...
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-3">
                                        <div class="fxt-content-between">
                                            ...
                                            <a href="<?= site_url('auth/lupa_password_member'); ?>" class="switcher-text2">Lupa Password</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
