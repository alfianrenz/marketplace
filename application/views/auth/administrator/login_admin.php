                    ...
                    <div class="fxt-content">
                        <div class="fxt-header">
                            ...
                            <div class="fxt-page-switcher">
                                <!-- <a href="login-1.html" class="switcher-text1 active">Masuk</a>
                                <a href="register-1.html" class="switcher-text1">Daftar</a> -->
                            </div>
                        </div>

                        <div class="fxt-form">
                            <h2 class="mb-2">Login Administrator</h2>
                            <p>Akses untuk kelola Waroeng Mahasiswa</p>

                            <?= $this->session->userdata('message'); ?>
                            <form method="POST" action="<?= site_url('auth'); ?>">
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-1">
                                        <input type="text" class="form-control" id="email" name="email" placeholder="Username atau Email" value="<?= set_value('email'); ?>">
                                ...
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-3">
                                        <div class="fxt-content-between">
                                            ...
                                            <a href="<?= site_url('auth/lupa_password_admin'); ?>" class="switcher-text2">Lupa Password</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
