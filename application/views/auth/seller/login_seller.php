                    ...
                    <div class="fxt-content">
                        <div class="fxt-header">
                            ...
                            <div class="fxt-page-switcher">
                                <a href="<?= site_url('auth/login_seller'); ?>" class="switcher-text1 active">Masuk</a>
                                <a href="<?= site_url('auth/registrasi_seller'); ?>" class="switcher-text1">Daftar</a>
                            </div>
                        </div>

                        <div class="fxt-form">
                            <h2 class="mb-2">Login Seller</h2>
                            <p>Masuk dan kelola waroengmu</p>

                            <?= $this->session->userdata('message'); ?>
                            <form method="POST" action="<?= site_url('auth/login_seller'); ?>">
                                ...
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-3">
                                        <div class="fxt-content-between">
                                            ...
                                            <a href="<?= site_url('auth/lupa_password_seller'); ?>" class="switcher-text2">Lupa Password</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
