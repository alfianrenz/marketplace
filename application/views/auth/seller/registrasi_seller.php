                    ...
                    <div class="fxt-content">
                        <div class="fxt-header">
                            ...
                            <div class="fxt-page-switcher">
                                <a href="<?= site_url('auth/login_seller'); ?>" class="switcher-text1">Masuk</a>
                                <a href="<?= site_url('auth/registrasi_seller'); ?>" class="switcher-text1 active">Daftar</a>
                            </div>
                        </div>

                        <div class="fxt-form">
                            <h2 class="mb-2">Daftar Seller</h2>
                            <p>Daftar dan mulai kelola waroengmu</p>

                            <?= $this->session->userdata('message'); ?>
                            <form method="POST" action="<?= site_url('auth/registrasi_seller'); ?>">

                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-1">
                                        <input type="text" class="form-control" id="nim" name="nim" placeholder="Nomor Induk Mahasiswa" value="<?= set_value('nim'); ?>">
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-1">
                                        <input type="text" class="form-control" id="waroeng" name="waroeng" placeholder="Nama Waroeng" value="<?= set_value('waroeng'); ?>">
                                    </div>
                                    <?= form_error('waroeng', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <div class="fxt-transformY-50 fxt-transition-delay-1">
