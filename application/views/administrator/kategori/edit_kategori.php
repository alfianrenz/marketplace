                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <label for="b-t-name" class="col-sm-2 col-form-label">Nama Kategori</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="kategori" name="kategori" placeholder="" value="<?= $kategori['nama_kategori']; ?>">
