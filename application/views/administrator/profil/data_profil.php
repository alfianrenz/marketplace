    ...
    <div class="pcoded-content">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mt-2">Profil Administrator</h5>
                        <a href="<?= site_url('profil/edit_profil_admin'); ?>" class="btn btn-primary btn-sm float-right"><i class="feather icon-edit"></i> Edit Profil</a>
                    </div>

                    <div class="card-body">
                        <div class="form-group row mt-3">
                            <div class="col-sm-3"></div>
                            <label for="b-t-name" class="col-sm-2">Nama </label>
                            <div class="col-sm-5">
                                <label for="b-t-name" class="col-sm-7">: <?= $admin['nama_admin']; ?> </label>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3"></div>
                            <label for="b-t-name" class="col-sm-2">Username </label>
                            <div class="col-sm-5">
                                <label for="b-t-name" class="col-sm-7">: <?= $admin['username_admin']; ?> </label>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3"></div>
                            <label for="b-t-name" class="col-sm-2 ">Email </label>
                            <div class="col-sm-5">
                                <label for="b-t-name" class="col-sm-7">: <?= $admin['email_admin']; ?> </label>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3"></div>
                            <label for="b-t-name" class="col-sm-2">Telepon </label>
                            <div class="col-sm-5">
                                <label for="b-t-name" class="col-sm-7">: <?= $admin['telepon_admin']; ?> </label>
                            </div>
                        </div>
            ...
            <!-- <div class=" col-sm-6 order-md-2">
                <div class="card">
                    <div class="card-header">
                        <h5 class="mt-2">Ganti Password</h5>
                    </div>
                    <div class="card-body">
                        <form action="" method="">
                            <div class="form-group row">
                                <div class="col-sm-1"></div>
                                <label for="b-t-name" class="col-sm-4 col-form-label">Password Lama</label>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-1"></div>
                                <label for="b-t-name" class="col-sm-4 col-form-label">Password Baru</label>
                                <div class="col-sm-5">
