<header class="navbar pcoded-header navbar-expand-lg navbar-light header-blue">
    <div class="m-header">
        ...
        <a href="#!" class="b-brand">
            <img src="<?= base_url(); ?>assets/admin/images/logo/logo-warma-admin.png" alt="" class="logo" width="170px">
            ...
            <li>
                <div class="dropdown drp-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-notification">
                        <div class="pro-head">
                            <img src="<?= base_url('assets/upload/foto_user/' . $session['foto_admin']); ?>" class="img-radius" alt="User-Profile-Image">
                            <span><?= $session['nama_admin']; ?></span>
                        </div>
                        <ul class="pro-body">
                            <li><a href="<?= site_url('profil/profil_admin'); ?>" class="dropdown-item"><i class="feather icon-user"></i> Profile</a></li>
